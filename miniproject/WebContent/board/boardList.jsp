...
<h3 align="center"><img src='../image/headerimage.gif' onclick="location.href='../main/index.do'" style="width:50px; height:50px; cursor:pointer;"></h3>
<hr>
...
<div style="text-align: center">
	<select name="searchType" style="width: 80px;">
