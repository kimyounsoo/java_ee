...
<table border="1">
<tr>
<td align="center" width="60px">제   목</td><td><input size = "100" type="text" name="subject" id="subject" placeholder="제목을 입력하세요" style="width:1000px; height:25px">
<div id="subjectDiv" style="color: red; font-size:8pt; font-weigth:bold;"></div>
</tr>
<tr>
<td align="center">내   용</td><td><textArea name="content" id="content" placeholder="내용을 입력하세요" rows="30" cols="100" style="width:1000px; height:480px; border:none; background: transparent; font-size:17pt; font-weight: bold; font-family: 'Typo_DecoSolidSlash'"></textArea>
<div id="contentDiv" style="color: red; font-size:8pt; font-weigth:bold;"></div>
</td>
</tr>
<tr>
<td align="center" colspan="2">
<input type="button" value="답글쓰기" style= "font-family: 'Typo_DecoSolidSlash'; font-size:30px; font-weight: bold;" onclick="checkBoardReply()">
