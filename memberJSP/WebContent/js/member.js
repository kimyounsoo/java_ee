...
function checkId(){
	...
	if(id=="")
		...
		window.open("checkId.jsp?id="+id,"checkId","width=450 height=150"); //팝업창 띄워주는 명령어
}								//둘중 하나에만 주소를 써주면 된다 "" ""
								//나머지 한군데""에는 팝업창의 아무 이름을 써주면 된다 그래야만 중복체크 창이 여러개 안뜬다
//				http://localhost:8080/memberJSP/member/ 빼도 상관없다

function checkPost(){
	window.open("checkPost.jsp", "", "width=700 height=500 scrollbars=yes"); //scrollbars=yes 익스플로러를 위한 스크롤바 크롬은 안해줘도 스크롤바가 있다
}
