...
<%
//데이터
String id = (String)session.getAttribute("memId"); //형변환

//DB
//MemberDAO memberDAO = MemberDAO.getInstance();// 5번째 줄로 해도되고 이렇게 해도되고
...
window.onload=function(){
	document.modifyForm.gender[<%=memberDTO.getGender()%>].checked = true; // 0인지 1인지는 DB에서 끌고 와야한다 radio 는 value 의 값이 배열로 잡힌다
