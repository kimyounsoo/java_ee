...
<fmt:formatNumber type="number" value="123456789.88" maxFractionDigits="1" /><br> <!-- 소수점 한자리까지 -->
<br>

<fmt:formatNumber type="number" value="123456.78" pattern="#,###" /><br> <!-- 소수점이하 자리수 표시가 없어서 123457 나온다 -->
